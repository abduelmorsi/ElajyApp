...
const styles = StyleSheet.create({
  ...
  donationSummaryAmount: { color: '#007bff', fontWeight: 'bold', fontSize: 14, textAlign: 'right' },
  ...
  donationSummaryTotalAmount: { color: '#007bff', fontWeight: 'bold', fontSize: 16, textAlign: 'right' },
  continueBtn: { backgroundColor: '#007bff', borderRadius: 8, alignItems: 'center', paddingVertical: 14, marginTop: 20 },
  ...
  confirmMedicineAmount: { color: '#007bff', fontWeight: 'bold', fontSize: 14, textAlign: 'right' },
