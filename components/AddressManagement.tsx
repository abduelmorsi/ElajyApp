...
import { Modal, ScrollView, StyleSheet, Switch, Text, TextInput, TouchableOpacity, View, SafeAreaView } from 'react-native';
...
const styles = StyleSheet.create({
  ...
  addButton: { flexDirection: 'row', alignItems: 'center', backgroundColor: '#49C5B8', borderRadius: 8, paddingHorizontal: 12, paddingVertical: 6 },
  ...
  formButtonPrimary: { backgroundColor: '#49C5B8' },
  ...
  addressCardDefault: { borderColor: '#49C5B8', borderWidth: 2 },
  ...
  defaultBadge: { backgroundColor: '#e6f7f5', borderRadius: 6, paddingHorizontal: 6, paddingVertical: 2, marginLeft: 4 },
  defaultBadgeText: { color: '#49C5B8', fontSize: 11, fontWeight: 'bold' },
